...
def get_all_ad_accounts():
    ...
    # Owned accounts with pagination
    url = f"https://graph.facebook.com/v18.0/{FB_BUSINESS_ID}/owned_ad_accounts"
    while url:
        ...
        all_accounts.extend(resp.get("data", []))
        url = resp.get("paging", {}).get("next")

    # Client accounts with pagination
    url = f"https://graph.facebook.com/v18.0/{FB_BUSINESS_ID}/client_ad_accounts"
    while url:
        resp = requests.get(url, params={
            "fields": "id,name,account_status",
            "limit": 100,
